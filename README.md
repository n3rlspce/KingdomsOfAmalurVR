...
**[⬇ Download experimental preview (.zip)](https://github.com/n3rlspce/KingdomsOfAmalurVR/releases/download/v0.1.0-preview.4/KingdomsOfAmalurVR.zip)** — [Release notes](https://github.com/n3rlspce/KingdomsOfAmalurVR/releases/tag/v0.1.0-preview.4) · [Installation guide](docs/INSTALL.md)
